...
// Wed Sep 26 09:43:46 2018 by ROOT version 5.34/30
// from TTree anatree/analysis tree
// found on file: RunIINegPickyPiMuE.root
//////////////////////////////////////////////////////////

#ifndef InElastic_v2_h
#define InElastic_v2_h
...
public :
   ...
   InElastic_v2(TTree *tree=0);
   virtual ~InElastic_v2();
...
#ifdef InElastic_v2_cxx
InElastic_v2::InElastic_v2(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/PionRunII_DDMC_AnaTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/PionRunII_DDMC_AnaTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/PionRunII_DDMC_AnaTree.root:/anatree");
...
InElastic_v2::~InElastic_v2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t InElastic_v2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t InElastic_v2::LoadTree(Long64_t entry)
{
...
void InElastic_v2::Init(TTree *tree)
{
...
void InElastic_v2::Show(Long64_t entry)
{
...
Int_t InElastic_v2::Cut(Long64_t entry)
{
